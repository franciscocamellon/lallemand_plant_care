...
class CropAnalysisEnvironment:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/crop_analysis_environment/icons/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Lallemand - Crop Analysis Environment'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = CropAnalysisEnvironmentUi(self.iface, self.project)
