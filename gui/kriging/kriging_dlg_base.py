...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tasksGroupBox = QtWidgets.QGroupBox(self.kriging)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tasksGroupBox.sizePolicy().hasHeightForWidth())
        self.tasksGroupBox.setSizePolicy(sizePolicy)
        self.tasksGroupBox.setMinimumSize(QtCore.QSize(0, 65))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.tasksGroupBox.setFont(font)
        self.tasksGroupBox.setCheckable(True)
        self.tasksGroupBox.setChecked(False)
        self.tasksGroupBox.setObjectName("tasksGroupBox")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.tasksGroupBox)
        ...
        self.variogramCheckBox = QtWidgets.QCheckBox(self.tasksGroupBox)
        self.variogramCheckBox.setStyleSheet("font: 8pt \"MS Shell Dlg 2\";")
        self.variogramCheckBox.setObjectName("variogramCheckBox")
        self.horizontalLayout_7.addWidget(self.variogramCheckBox)
        self.interpolationCheckBox = QtWidgets.QCheckBox(self.tasksGroupBox)
        self.interpolationCheckBox.setStyleSheet("font: 8pt \"MS Shell Dlg 2\";")
        self.interpolationCheckBox.setObjectName("interpolationCheckBox")
        self.horizontalLayout_7.addWidget(self.interpolationCheckBox)
        self.saveParametersCheckBox = QtWidgets.QCheckBox(self.tasksGroupBox)
        self.saveParametersCheckBox.setStyleSheet("font: 8pt \"MS Shell Dlg 2\";")
        self.saveParametersCheckBox.setObjectName("saveParametersCheckBox")
        self.horizontalLayout_7.addWidget(self.saveParametersCheckBox)
        self.verticalLayout_5.addLayout(self.horizontalLayout_7)
        self.verticalLayout_15.addLayout(self.verticalLayout_5)
        self.gridLayout_2.addWidget(self.tasksGroupBox, 2, 0, 1, 1)
        ...
        Dialog.setTabOrder(self.boundaryLayerComboBox, self.tasksGroupBox)
        Dialog.setTabOrder(self.tasksGroupBox, self.variogramCheckBox)
        Dialog.setTabOrder(self.variogramCheckBox, self.interpolationCheckBox)
        Dialog.setTabOrder(self.interpolationCheckBox, self.saveParametersCheckBox)
        Dialog.setTabOrder(self.saveParametersCheckBox, self.interpolatePushButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tasksGroupBox.setTitle(_translate("Dialog", "Tasks"))
        self.variogramCheckBox.setText(_translate("Dialog", "Variogram"))
        self.interpolationCheckBox.setText(_translate("Dialog", "Interpolated map"))
        self.saveParametersCheckBox.setText(_translate("Dialog", "Save parameters"))
